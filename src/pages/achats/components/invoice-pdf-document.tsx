...
interface ProviderPdfDocumentProps {
  provider: provider;
}

export const InvoicePdfDocument: FC<ProviderPdfDocumentProps> = (props) => {
  const { provider } = props;
  const styles = useStyles();

  const dueDate = provider.dueDate && format(provider.dueDate, 'dd MMM yyyy');
  const issueDate = provider.depositedDate && format(provider.depositedDate, 'dd MMM yyyy');
    ...
    <Document>
      ...
      >
        <View style={styles.header}>
          ...
          <View>
            <Text style={styles.subtitle2}>{provider.id}</Text>
          </View>
        </View>
        ...
        <View style={styles.references}>
          ...
          <View>
            ...
            <Text style={styles.body2}>{provider.nom}</Text>
          </View>
        </View>
        ...
        <View style={styles.items}>
          ...
          <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryValue}>
              <Text style={[styles.body2, styles.alignRight]}>{provider.amount}</Text>
            </View>
          </View>
        </View>
        <View style={styles.notes}>
          <Text style={[styles.h6, styles.gutterBottom]}>Notes</Text>
          <Text style={styles.body2}>{provider.commentaire}</Text>
        </View>
      </Page>
    </Document>
  );
